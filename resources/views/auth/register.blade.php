                ...
                <div class="card-body mb-5">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('division') is-invalid @enderror" name="division_id" id="division_id" value="{{ old('division') }}" required autocomplete="division">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('district') is-invalid @enderror" name="district_id" value="{{ old('district') }}" required autocomplete="district" id="district-area">
...
<script type="text/javascript" src="{{ asset('js/jquery-3.4.1.min.js') }}"></script>
    <script>
        ...
        $("#division_id").change(function(){
            ...
            $("#district-area").html("");
            var option = "";
            // send an ajax request to server with this division, in api routes
            $.get("http://localhost/ecommerce/public/get-district/"+division,function( data ){
