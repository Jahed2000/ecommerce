	...
	<div class="card-body mb-5">
                    <form method="POST" action="{{ route('user.profile.update',$user->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('division') is-invalid @enderror" name="division_id" value="{{ old('division') }}" required autocomplete="division" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('district') is-invalid @enderror" name="district_id" value="{{ old('district') }}" required autocomplete="district">
