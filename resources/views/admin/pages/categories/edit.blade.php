                ...
                <div class="card-body" style="width: 100%;">
                  ...
                  <form action="{{ route('admin.category.update', $category->id) }}" method="post" class="forms-sample" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control" id="exampleInputName1" value="{{$category->name}}" placeholder="name">
                    </div>
                    <!-- <div class="form-group ">
                    ...
                    <div class="form-group">
                      ...
                      <textarea  name="description" class="form-control" id="exampleTextarea1" rows="3" placeholder="description">{{$category->description}}</textarea>
                    </div>
                    <div class="form-group">
