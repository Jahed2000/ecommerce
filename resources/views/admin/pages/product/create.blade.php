            ...
            <div class="col-md-8 offset-md-2">
              ...
              <div class="card">
                <div class="card-body" style="width: 100%;background: #ccc;">
                  ...
                  <form action="{{ route('admin.product.store') }}" method="post" class="forms-sample" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="quantity" class="form-control" id="exampleInputName1" placeholder="quantity">
                    </div>
                    {{-- <div class="form-group">
                    ...
                    <div class="form-group">
                          ...
                          <select name="category_id" class="form-control" id="exampleSelect1">
                            ...
                            <option value="{{ $cat->id }}">{{ strtoupper($cat->name) }}</option> {{-- strtoupper to capitalize string --}}
                            @foreach(App\Models\Category::orderBy('id','asc')->where('parent_id',$cat->id)->get() as $child)
